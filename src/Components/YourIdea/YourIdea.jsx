    ...
    return (
        <div className="mt-40 w-4/5 mx-auto">
            <div className="relative">
                <h1 className="font-Inter font-bold text-5xl text-center">Collaborate without<br />constraints</h1>
                <div className="bg-[#FFD02F] w-[172px] mx-auto rounded-lg font-semibold transform rotate-[10deg] absolute right-48 bottom-28">
                    <p className="uppercase text-sm text-center">Your Idea Starts Here</p>
                </div>
            </div>
            <div className="mt-3 flex gap-5 justify-between">
                <div className="w-[360px] p-4">
                    <h3 className="font-Inter font-bold text-2xl">Free forever</h3>
                ...
                <div className="w-[360px] p-4">
                    <h3 className="font-Inter font-bold text-2xl">Easy integrations</h3>
                ...
                <div className="w-[360px] p-4">
                    <h3 className="font-Inter font-bold text-2xl">Security first</h3>
