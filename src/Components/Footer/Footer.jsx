...
const Footer = () => {
    return (
        <div className="h-[680px] bg-[#02033B] py-24">
            <div className="w-4/5 mx-auto">
                <div className="flex gap-[60px]">
                    ...
                    <div className="w-[520px] h-[250px] bg-[#FFC247] rounded-[42px] relative">
                        <img src="https://i.ibb.co/YPJ3PHb/Path-10741.png" alt="" className="mx-auto" />
                        <div className="absolute w-[364px] top-[35px] left-9">
                            <h1 className="font-Inter text-[#02033B] font-extrabold text-[23px]">Sign up to our newsletter</h1>
                            <p className="font-Inter text-[15px] text-[#02033B] mt-[21px]">Receive the latest mobile security news, exclusive discounts & offers straight to your inbox!</p>
                            <input type="text" className="text-[#02033B80] py-2 pl-4 rounded-l-[21px] mt-9 w-[254.8px] h-[34.39px]" placeholder="Email address" />
                            <button className="font-Inter font-extrabold text-white text-[15px] bg-[#02033B] py-2 w-[109.19px] h-[34.39px] text-center rounded-r-[21px]">Submit</button>
                        </div>
                    </div>
                </div>
