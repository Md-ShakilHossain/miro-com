...
const LovedByTeams = () => {
    return (
        <div className="mb-28 w-4/5 mx-auto">
            <h1 className="font-Inter font-bold text-5xl text-center">Built for all kinds of teams</h1>
            ...
            <div className="flex justify-between gap-5 mt-10">
                <div className="pl-9 pt-9 w-[360px]">
                    ...
                    <div className="flex gap-4 mt-[51px] items-center">
                        <div>
                ...
                <div className="pl-9 pt-9 w-[360px]">
                    ...
                    <div className="flex gap-4 mt-[138.92px] items-center">
                        <div>
                ...
                <div className="pl-9 pt-9 w-[360px]">
                    ...
                    <div className="flex gap-4 mt-[112px] items-center">
                        <div>
